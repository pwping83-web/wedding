...
function entranceTimingPromptLines(
  ...
  return [
    ...
    '톤: 웨딩홀 MC 실제 입장 멘트. 신부 예시 — "세상에서 가장 사랑스럽고 아름다운 걸음이 시작됩니다. 오늘, 한 남자에게 인생의 가장 소중한 선물이 되어줄 사람… 우리 모두의 축복과 박수를 보내주시기 바랍니다. 신부 입장!" / 신랑 예시 — "다음은 신랑 입장이 있겠습니다. 오늘의 주인공, 이제 이 자리에 섭니다… 신랑 입장!"',
