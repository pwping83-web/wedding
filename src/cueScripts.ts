...
export const itemScripts: Record<string, MoodScripts> = {
  ...
  '신랑 입장': hall(
    '다음은 신랑입장이 있겠습니다. 오늘의 주인공, 이제 이 자리에 섭니다. 늘 성실하고 반듯했던 사람, 이제 한 여자의 남편으로 새 인생을 시작하려 합니다. 지금까지와는 또 다른 새로운 인생을 향해 걸어 나오는 신랑에게 우리 모두의 축복과 박수를 보내주시기 바랍니다. 신랑 입장!',
  ),

  '신부 입장': hall(
    '세상에서 가장 사랑스럽고 아름다운 걸음이 시작됩니다. 오늘, 한 남자에게 인생의 가장 소중한 선물이 되어줄 사람, 그리고 오늘부로 한 가정의 든든한 반쪽이 될 사람입니다. 지금까지와는 또 다른 새로운 인생을 향해 걸어 나오는 신부에게 우리 모두의 축복과 박수를 보내주시기 바랍니다. 신부 입장!',
  ),
